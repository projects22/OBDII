...
#define spi_readwrite SPI   //SPI.transfer
#define spi_read() SPI(0x00)    //spi_readwrite(0x00)
...
*********************************************************************************************************/
INT8U setMode(const INT8U opMode)
{
    mcpMode = opMode;
...
*********************************************************************************************************/
INT8U init_Mask2(INT8U num, INT8U ext, INT32U ulData)
{
...
*********************************************************************************************************/
INT8U init_Filt2(INT8U num, INT8U ext, INT32U ulData)
{
    INT8U res = MCP2515_OK;
#if DEBUG_MODE
...
*********************************************************************************************************/
INT8U sendMsgBuf2(INT32U id, INT8U ext, INT8U len, INT8U *buf)
{
    INT8U res;
...
*********************************************************************************************************/
INT8U readMsgBuf2(INT32U *id, INT8U *ext, INT8U *len, INT8U buf[])
{
